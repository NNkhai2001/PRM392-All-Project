        ...
        implements SurfaceHolder.Callback
{
    ...
    private void showGameOverDialog(final int messageId)
    {
        ...
        final AlertDialog.Builder dialoBuilder =
                new AlertDialog.Builder(getContext());
        dialoBuilder.setTitle(getResources().getString(messageId));
        dialoBuilder.setCancelable(false);

        dialoBuilder.setMessage(getResources().getString(
                R.string.results_format,shotsFired,totalElapsedTime));
        dialoBuilder.setPositiveButton(R.string.reset_game,
